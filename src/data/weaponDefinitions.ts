...
/** Base sell price for an unenchanted weapon. */
export const getBaseWeaponSellPrice = (weapon: WeaponDef): number => {
  return weapon.shopPrice ? Math.floor(weapon.shopPrice * 0.5) : weapon.attack * 15
}
