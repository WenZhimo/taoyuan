...
import {
  ...
  type ThirdPartyDataPackElectronResponseDeliverySinkAdapterCheck,
...
export const THIRD_PARTY_DATA_PACK_ELECTRON_RESPONSE_DELIVERY_SINK_SOURCE_KIND =
  'third-party-electron-response-delivery-sink-source'
export const THIRD_PARTY_DATA_PACK_ELECTRON_RESPONSE_DELIVERY_SINK_SOURCE_MODE =
  'default-disabled-electron-response-delivery-sink-source'

export type ThirdPartyDataPackElectronResponseDeliverySinkSourceStatus =
  | 'delivered'
  | 'skipped'
  | 'blocked'

export interface ThirdPartyDataPackElectronResponseDeliverySinkSourceEnvelopeSummary {
...
export interface ThirdPartyDataPackElectronResponseDeliverySinkSourceEffectSummary {
  readonly electronResponseDeliverySinkSourceCalled: boolean
  readonly platformSplitContractSourceCalled: boolean
  readonly electronSinkAdapterCalled: boolean
  readonly electronSinkHostCalled: boolean
...
export interface ThirdPartyDataPackElectronResponseDeliverySinkSourceResult {
  readonly kind: typeof THIRD_PARTY_DATA_PACK_ELECTRON_RESPONSE_DELIVERY_SINK_SOURCE_KIND
  readonly mode: typeof THIRD_PARTY_DATA_PACK_ELECTRON_RESPONSE_DELIVERY_SINK_SOURCE_MODE
  readonly platform: 'electron'
  readonly status: ThirdPartyDataPackElectronResponseDeliverySinkSourceStatus
  ...
  readonly sourcePlatformSplitStatus?: ThirdPartyDataPackElectronResponseDeliverySinkAdapterResult['sourcePlatformSplitStatus']
  readonly electronResponseDeliverySinkAdapterStatus?: ThirdPartyDataPackElectronResponseDeliverySinkAdapterResult['status']
  ...
  readonly lockfileHash?: Sha256Hash
  readonly deliveryEnvelopeSummary?: ThirdPartyDataPackElectronResponseDeliverySinkSourceEnvelopeSummary
  ...
  readonly summary: ThirdPartyDataPackUiIpcResultEnvelopeSummary
  readonly effects: ThirdPartyDataPackElectronResponseDeliverySinkSourceEffectSummary
}

export interface CreateThirdPartyDataPackElectronResponseDeliverySinkSourceOptions {
  readonly enabled?: boolean
...
export class ThirdPartyDataPackElectronResponseDeliverySinkBlockedError extends Error {
  readonly result: ThirdPartyDataPackElectronResponseDeliverySinkSourceResult

  constructor(result: ThirdPartyDataPackElectronResponseDeliverySinkSourceResult) {
    super('third-party Electron response delivery sink source blocked response delivery continuation')
    this.name = 'ThirdPartyDataPackElectronResponseDeliverySinkBlockedError'
    this.result = result
  }
}
...
const forbiddenElectronSinkSourceFields = [
...
const safeDiagnostic = (
  ...
  return Object.freeze({
    ...
    stage: readOwnStringField(diagnostic, 'stage')
      ?? 'third-party.electron-response-delivery-sink-source.diagnostic-copy',
...
const cloneCheck = (
  check: object
): ThirdPartyDataPackElectronResponseDeliverySinkAdapterCheck | undefined => {
  ...
  return Object.freeze({
    id: id as ThirdPartyDataPackElectronResponseDeliverySinkAdapterCheck['id'],
    status,
    reason: readOwnStringField(check, 'reason') ?? 'Electron response delivery sink source copied adapter check.'
  })
}

const cloneChecks = (
  checks: unknown
): readonly ThirdPartyDataPackElectronResponseDeliverySinkAdapterCheck[] => {
  if (!Array.isArray(checks)) return Object.freeze([])
  const length = readArrayLength(checks)
  if (length === undefined) return Object.freeze([])

  const result: ThirdPartyDataPackElectronResponseDeliverySinkAdapterCheck[] = []
  for (let index = 0; index < length; index += 1) {
    let descriptor: PropertyDescriptor | undefined
    try {
...
const cloneAcknowledgement = (
  ...
  envelopeSummary: ThirdPartyDataPackElectronResponseDeliverySinkSourceEnvelopeSummary | undefined
...
): ThirdPartyDataPackElectronResponseDeliverySinkSourceEnvelopeSummary | undefined => {
...
const deliveryEffectKeysFor = (
  ...
  const keys = ['electronIpcResponseSent', 'uiIpcResponseDelivered']
...
const pathFreeElectronSinkAdapterSource = (
  source: ThirdPartyDataPackElectronResponseDeliverySinkAdapterResult
): boolean => forbiddenElectronSinkSourceFields.every(fieldName => !hasOwnEnumerableField(source, fieldName))
...
const noRuntimeOrWriteDrift = (
  ...
  && readOwnBooleanField(source, 'electronIpcAllowed') === delivered
  && readOwnBooleanField(source, 'electronResponseDeliveryAllowed') === delivered
...
const safeSkippedAdapterSource = (
  ...
  && readOwnBooleanField(source, 'electronResponseDeliveryAttempted') === false
  && readOwnBooleanField(source, 'electronResponseDelivered') === false
  && noRuntimeOrWriteDrift(source, false, undefined)
  && pathFreeElectronSinkAdapterSource(source)
...
const safeDeliveredAdapterSource = (
  ...
  && readOwnBooleanField(source, 'electronResponseDeliveryAttempted') === true
...
const effectSummary = (
  status: ThirdPartyDataPackElectronResponseDeliverySinkSourceStatus,
  sourceCalled: boolean,
  adapter?: ThirdPartyDataPackElectronResponseDeliverySinkAdapterResult,
  envelopeKind?: ThirdPartyDataPackUiIpcResultEnvelopeOutcomeKind
): ThirdPartyDataPackElectronResponseDeliverySinkSourceEffectSummary => {
  const delivered = status === 'delivered'
  return Object.freeze({
    electronResponseDeliverySinkSourceCalled: true,
    platformSplitContractSourceCalled: sourceCalled,
    electronSinkAdapterCalled: adapter !== undefined,
    electronSinkHostCalled: readOwnBooleanField(adapter, 'electronResponseDeliveryAttempted') === true,
...
const baseResult = (
  options: {
    ...
    readonly adapter?: ThirdPartyDataPackElectronResponseDeliverySinkAdapterResult
    readonly diagnostics?: readonly ThirdPartyDataPackUiIpcResultEnvelopeSafeDiagnostic[]
  }
): ThirdPartyDataPackElectronResponseDeliverySinkSourceResult => {
  ...
  return deepFreezeObjectGraph({
    kind: THIRD_PARTY_DATA_PACK_ELECTRON_RESPONSE_DELIVERY_SINK_SOURCE_KIND,
    mode: THIRD_PARTY_DATA_PACK_ELECTRON_RESPONSE_DELIVERY_SINK_SOURCE_MODE,
    platform: 'electron',
    ...
    electronSinkAdapterCalled: options.adapter !== undefined,
    electronResponseDelivered: delivered,
    ...
    sourcePlatformSplitStatus: readOwnStringField(options.adapter, 'sourcePlatformSplitStatus') as
      | ThirdPartyDataPackElectronResponseDeliverySinkAdapterResult['sourcePlatformSplitStatus']
      | undefined,
    electronResponseDeliverySinkAdapterStatus: readOwnStringField(options.adapter, 'status') as
      | ThirdPartyDataPackElectronResponseDeliverySinkAdapterResult['status']
      | undefined,
...
const evaluateElectronResponseDeliverySinkSource = async(
  options: CreateThirdPartyDataPackElectronResponseDeliverySinkSourceOptions
): Promise<ThirdPartyDataPackElectronResponseDeliverySinkSourceResult> => {
  if (options.enabled !== true) {
    return baseResult({
      status: 'skipped',
      reason: 'third-party Electron response delivery sink source is disabled by default',
      enabled: false,
      sourceCalled: false
    })
  }
  ...
  if (options.readUiIpcResponseDeliveryPlatformSplitContract === undefined) {
    return baseResult({
      status: 'blocked',
      reason: 'third-party Electron response delivery sink source is enabled without a platform split contract source',
      enabled: true,
      sourceCalled: false,
      diagnostics: [
        commandDiagnostic('third-party.electron-response-delivery-sink-source.missing-source')
      ]
    })
  }
  ...
  try {
    ...
    return baseResult({
      status: 'blocked',
      reason: 'third-party Electron response delivery platform split source failed before returning a safe result',
      enabled: true,
      sourceCalled: true,
      diagnostics: [
        commandDiagnostic('third-party.electron-response-delivery-sink-source.source-failed')
      ]
    })
  }

  let adapter: ThirdPartyDataPackElectronResponseDeliverySinkAdapterResult
  try {
    adapter = await deliverThirdPartyDataPackElectronResponseDeliverySinkAdapter({
    ...
    return baseResult({
      status: 'blocked',
      reason: 'third-party Electron response delivery sink adapter failed before returning a safe result',
      enabled: true,
      sourceCalled: true,
      platformSplit,
      diagnostics: [
        commandDiagnostic(
          'third-party.electron-response-delivery-sink-source.adapter-failed',
  ...
  if (safeSkippedAdapterSource(adapter)) {
    return baseResult({
      status: 'skipped',
      reason: 'third-party Electron response delivery is not required because the platform split was skipped',
      enabled: true,
      sourceCalled: true,
      platformSplit,
      adapter,
  ...
  if (safeDeliveredAdapterSource(adapter, envelopeSummary, acknowledgement)) {
    return baseResult({
      status: 'delivered',
      reason: 'third-party Electron response delivery sink source accepted a delivered fixed-channel Electron acknowledgement',
      enabled: true,
      sourceCalled: true,
      platformSplit,
      adapter,
  ...
  const blockedDiagnostics = [
    ...adapterDiagnostics,
    ...(!pathFreeElectronSinkAdapterSource(adapter) || !noRuntimeOrWriteDrift(adapter, false, envelopeSummary?.kind)
      ? [
          commandDiagnostic(
            'third-party.electron-response-delivery-sink-source.unsafe-source',
            targetPackageId
          )
        ]
      : []),
    commandDiagnostic(
      'third-party.electron-response-delivery-sink-source.delivery-blocked',
      targetPackageId
    )
  ]
  ...
  return baseResult({
    status: 'blocked',
    reason: 'third-party Electron response delivery sink source requires a safe delivered Electron acknowledgement before continuation',
    enabled: true,
    sourceCalled: true,
    platformSplit,
    adapter,
...
export const createThirdPartyDataPackElectronResponseDeliverySinkSource = (
  options: CreateThirdPartyDataPackElectronResponseDeliverySinkSourceOptions = {}
): (() => Promise<ThirdPartyDataPackElectronResponseDeliverySinkSourceResult>) => async() => {
  const result = await evaluateElectronResponseDeliverySinkSource(options)
  if (result.status === 'blocked') {
    throw new ThirdPartyDataPackElectronResponseDeliverySinkBlockedError(result)
  }
  return result
}

export const thirdPartyDataPackElectronResponseDeliverySinkSource =
  createThirdPartyDataPackElectronResponseDeliverySinkSource()
