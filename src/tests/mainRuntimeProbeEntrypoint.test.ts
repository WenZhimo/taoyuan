...
describe('main runtime probe entrypoint', () => {
  ...
  it('routes Web visible initial install write-failure probes as blocked import runs', async() => {
    ...
    window.history.replaceState(
      null,
      '',
      '/?taoyuanContentProbe=1&taoyuanThirdPartyVisibleImportProbe=1&taoyuanThirdPartyVisibleImportPersistSource=1&taoyuanThirdPartyVisibleInstallFailAfterModLockWrite=1'
    )
  ...
  it('routes Web visible dependency install write-failure probes as blocked import runs', async() => {
    const visibleImportResult = {
      status: 'blocked',
      operation: 'install',
    ...
    window.history.replaceState(
      null,
      '',
      '/?taoyuanContentProbe=1&taoyuanThirdPartyVisibleImportProbe=1&taoyuanThirdPartyVisibleImportPersistSource=1&taoyuanThirdPartyVisibleInstallFailAfterModLockWrite=1&taoyuanThirdPartyVisibleDependencyProbe=1'
    )
  ...
  it('routes Web visible dependency ZIP install write-failure probes as blocked import runs', async() => {
    const visibleImportResult = {
      status: 'blocked',
      operation: 'install',
      archiveImportButtonClicked: true,
    ...
    window.history.replaceState(
      null,
      '',
      '/?taoyuanContentProbe=1&taoyuanThirdPartyVisibleImportProbe=1&taoyuanThirdPartyVisibleImportPersistSource=1&taoyuanThirdPartyVisibleInstallFailAfterModLockWrite=1&taoyuanThirdPartyVisibleArchiveImportProbe=1&taoyuanThirdPartyVisibleDependencyProbe=1'
    )
