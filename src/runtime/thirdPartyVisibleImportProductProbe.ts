...
export const runThirdPartyVisibleImportProductProbe = async(
  ...
  const effects: ThirdPartyVisibleImportProductProbeResult['effects'] = operation === 'enable'
    ? {
        ...
        realAppStartupHostCalled: enableTerminal?.realAppStartupHostCalled === true,
        gameAppCreated: enableTerminal?.gameAppCreated === true,
        piniaCreated: enableTerminal?.piniaCreated === true,
        routerMounted: enableTerminal?.routerMounted === true,
        savesWritten: false,
        cacheWritten: false,
...
export const runThirdPartyVisibleDisableProductProbe = async(
  ...
  return Object.freeze({
    ...
    effects: {
      ...
      realNormalStartupHostCalled: false,
      realAppStartupHostCalled: terminal?.realAppStartupHostCalled === true,
      gameAppCreated: terminal?.gameAppCreated === true,
      piniaCreated: terminal?.piniaCreated === true,
      routerMounted: terminal?.routerMounted === true,
